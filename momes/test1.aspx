<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test1.aspx.cs" Inherits="momes.test1" %>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg p-0">
                ...
                <div style="padding-left: 20px;" class="login-reg">
                    <asp:Button BackColor="White" class="cmn-btn" ID="Button3" runat="server" Text="Sign Up" />
                    <asp:Button BorderStyle="Dashed" class="cmn-btn" ID="Button4" runat="server" Text="Sign In" />
