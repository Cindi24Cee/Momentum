<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage_Branches.aspx.cs" Inherits="momes.Manage_Branches" %>
                  ...
                  <div class="frm-group text-center">
                      ...
                      <div class="frm-group">
                          <div style="float: left;" class="col-md-6">
                              ...
                              &nbsp;
                              <asp:Button ID="btnUpdate" class="cmn-btn" runat="server" Text="Update" />
                              &nbsp;
                             <asp:Button ID="btnDelete" class="cmn-btn" runat="server" Text="Delete" />
                              &nbsp;
                          </div>
                       ...
                       <div style="float: right;" class="col-md-6">
                        ...
                        <asp:ListView ID="lstBranches" runat="server">
                            ...
                            <ItemTemplate>
                                        ...
                                        <div class="car-item car-item--style2">
                                            ...
                                            <div class="car-item-body">
                                               ...
                                               <ul class="details-list">
                                                        <li><i class="fa fa-company"></i><%# Eval("BranchName")%>   </li>
                                               </ul>
                                ...
                                <!-- car-item end -->
                                       ...
                                       <asp:DataPager ID="DataPager1" runat="server" PagedControlID="lstBranches" PageSize="3">
                               <Fields>
                           ...
                           <asp:GridView ID="grdBranch" runat="server" Visible="false" OnRowEditing="grdBranch_RowEditing" OnRowDeleting="grdBranch_RowDeleting" AllowCustomPaging="True" AllowPaging="True" PageIndex="1" PageSize="5" CellPadding="4" ForeColor="#333333" GridLines="None">
