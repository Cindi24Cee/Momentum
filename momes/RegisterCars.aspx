<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterCars.aspx.cs" Inherits="momes.RegisterCars" %>
               ...
               <%-- <div class="frm-group text-center">
                ...
                <div  class="frm-group text-center">
                 ...
                 <div style="float:right;" class="col-md-6" >
                     <input type="password" name="pass" id="txtModel" placeholder="Car Model"><br /><br />&nbsp;
                 </div>
                   <div style="float:left;" class="col-md-6">
                       <input type="password" name="pass" id="txtColor" placeholder="Color"><br /><br />&nbsp;
                   </div>
                 ...
                 <div class="frm-group">
                 <div style="float:right;" class="col-md-6" >
                     <input type="password" name="pass" id="txtAge" placeholder="License No"><br /><br />&nbsp;
                 </div>
                   <div style="float:left;" class="col-md-6">
                       <input type="password" name="pass" id="txtAe" placeholder="Mileage"><br /><br />&nbsp;
                   </div>
                  
                      <div class="frm-group">
                 <div style="float:right;" class="col-md-6" >
                     <input type="password" name="pass" id="txtAge" placeholder="Car Year Model"><br /><br />&nbsp;
                 </div>
                   <div style="float:left;" class="col-md-6">
                       <input type="password" name="pass" id="txtAe" placeholder="Door"><br /><br />&nbsp;
                   </div>
                  
                </div>
                <div class="frm-group">
                 <div style="float:right;" class="col-md-6" >
                     <input type="password" name="pass" id="txtAge" placeholder="Power"><br /><br />&nbsp;
                 </div>
                   <div style="float:left;" class="col-md-6">
                       <input type="password" name="pass" id="txtAe" placeholder="Car Model"><br /><br />&nbsp;
                   </div>
                    
                    <div style="float:right;" class="col-md-6" >

                     <asp:Label ID="Label1" runat="server" Text="Car Image"></asp:Label>
                   ...
                   <div class="frm-group">
                <asp:Button class="cmn-btn" ID="btnLog" runat="server" Text="Register Vehicle" />
                </div>
              </form>
