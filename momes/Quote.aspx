<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quote.aspx.cs" Inherits="momes.Quote" %>
        ...
        <div class="col-lg-12">
          <div class="login-block text-center">
            <div class="login-block-inner">
                ...
                <div class ="head">
            <h2 style="color:orange;">Quotation Details</h2></div>
        <table class="auto-style4">
            <tr>
                <th class="auto-style5">Rental Detail</th>
            </tr>
            <tr>
                ...
                <td class="auto-style3">
                  ...
                  <div class="row">
                      <div class="col-md-0"></div>
                       ...
                       <div class="col-md-4"><asp:Button ID="btnDownload" class="cmn-btn" runat="server" Text="Print Quote" OnClientClick="javascript:window.print();" /></div>
                       <div class="col-md-4"> <asp:Button ID="btnSend" class="cmn-btn" runat="server" Text="Send Me Quote" OnClick="btnSend_Click" /> </div>
                       <div class="col-md-4"><asp:Button ID="Button" class="cmn-btn" runat="server" Text="Book Me Now" OnClick="Button_Click" />   </div>
